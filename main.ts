...
basic.forever(function () {
    ...
    radio.sendValue("MH", MoyenneHaut)
    radio.sendValue("MB", MoyenneBas)
    radio.sendValue("MG", MoyenneGauche)
    radio.sendValue("MD", MoyenneDroite)
    radio.sendValue("DL", delaislecture)
    radio.sendValue("Tol", tolerance)
})
basic.forever(function () {
